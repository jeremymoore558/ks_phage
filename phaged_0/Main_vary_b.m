...
parfor ii = 1:length(cell2b)
    for jj = 1:length(cell2Chi)    
        ...
        SimParams.OutFolderName = './Outputs_b/OutputsbChi/';
...
parfor ii = 1:length(cell2b)
    for jj = 1:length(cell2cA)    
        ...
        SimParams.OutFolderName = './Outputs_b/OutputsbcA/';
...
parfor ii = 1:length(cell2b)
    for jj = 1:length(cell2cR)    
        ...
        SimParams.OutFolderName = './Outputs_b/OutputsbcR/';
...
parfor ii = 1:length(cell2b)
    for jj = 1:length(cell2Y)    
        ...
        SimParams.OutFolderName = './Outputs_b/OutputsbY/';
...
parfor ii = 1:length(cell2b)
    for jj = 1:length(cell2I)    
        ...
        SimParams.OutFolderName = './Outputs_b/OutputsIb/';
