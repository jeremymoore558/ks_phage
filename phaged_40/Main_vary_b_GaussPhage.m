...
parfor ii = 1:length(cell2b)
    for jj = 1:length(cell2Chi)    
        ...
        SimParams.OutFolderName = './Outputs_b_GaussPhage/OutputsbChi/';
...
parfor ii = 1:length(cell2b)
    for jj = 1:length(cell2cA)    
        ...
        SimParams.OutFolderName = './Outputs_b_GaussPhage/OutputsbcA/';
...
parfor ii = 1:length(cell2b)
    for jj = 1:length(cell2cR)    
        ...
        SimParams.OutFolderName = './Outputs_b_GaussPhage/OutputsbcR/';
...
parfor ii = 1:length(cell2b)
    for jj = 1:length(cell2Y)    
        ...
        SimParams.OutFolderName = './Outputs_b_GaussPhage/OutputsbY/';
...
parfor ii = 1:length(cell2b)
    for jj = 1:length(cell2I)    
        ...
        SimParams.OutFolderName = './Outputs_b_GaussPhage/OutputsIb/';
